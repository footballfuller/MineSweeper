	   ...
	   console.log("row: " + r + " col: " + " " + c
			+ " content: " + content);
			 ...
			 if (content == 15) {
				...
				addHTML("outputEl", `<img id='ImgS' src='square.jpg' alt='Regular Square' onclick='myFunction(${x},${y})' >`);
		 addHTML("outputEl", " ");
			}else if (content == 18) {           //square with hidden bomb
			var x=r;
				var y=c;
				addHTML("outputEl", `<img id='ImgSB' src='square.jpg' alt='Regular Square' onclick='myFunction(${x},${y})'>`);
		 addHTML("outputEl", " ");
			}else if(content==0){
				var x=r;
				var y=c;
			addHTML("outputEl", `<img id='Img0' src='0.jpg' alt='Zero Square' onclick='myFunction(${x},${y})'>`);    
		 addHTML("outputEl", " ");
			}
	}
	addHTML("outputEl", "<br>");
